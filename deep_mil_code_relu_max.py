...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  2 20:42:05 2018
...
for i in range(8):
    ...
    if i==1:
        ...
        X_train=np.concatenate((X[0:7,:,:],X[14:53,:,:]),axis=0)
        y_train=np.concatenate((Y[0:7,:],Y[14:53,:]),axis=0)
        X_test=X[7:14,:,:]
        y_test=Y[7:14,:]
        
        Y_o=Y_Ori[7:14,:]
        Y_oo=np.concatenate((Y_Ori[0:7,:],Y_Ori[14:53,:]),axis=0)
        
    elif i==3:
        X_train=np.concatenate((X[0:14,:,:],X[21:53,:,:]),axis=0)
        y_train=np.concatenate((Y[0:14,:],Y[21:53,:]),axis=0)
        X_test=X[14:21,:,:]
        y_test=Y[14:21,:]
        
        Y_o=Y_Ori[14:21,:]
        Y_oo=np.concatenate((Y_Ori[0:14,:],Y_Ori[21:53,:]),axis=0)
    elif i==4:
        X_train=np.concatenate((X[0:21,:,:],X[28:53,:,:]),axis=0)
        y_train=np.concatenate((Y[0:21,:],Y[28:53,:]),axis=0)
        X_test=X[21:28,:,:]
        y_test=Y[21:28,:]
        
        Y_o=Y_Ori[21:28,:]
        Y_oo=np.concatenate((Y_Ori[0:21,:],Y_Ori[28:53,:]),axis=0)
    elif i==5:
        
        X_train=np.concatenate((X[0:28,:,:],X[35:53,:,:]),axis=0)
        y_train=np.concatenate((Y[0:28,:],Y[35:53,:]),axis=0)
        X_test=X[28:35,:,:]
        y_test=Y[28:35,:]
        
        Y_o=Y_Ori[28:35,:]
        Y_oo=np.concatenate((Y_Ori[0:28,:],Y_Ori[35:53,:]),axis=0)
    elif i==6:
        X_train=np.concatenate((X[0:35,:,:],X[42:53,:,:]),axis=0)
        y_train=np.concatenate((Y[0:35,:],Y[42:53,:]),axis=0)
        X_test=X[35:42,:,:]
        y_test=Y[35:42,:]
        
        Y_o=Y_Ori[35:42,:]
        Y_oo=np.concatenate((Y_Ori[0:35,:],Y_Ori[42:53,:]),axis=0)
    elif i==7:
        X_train=np.concatenate((X[0:42,:,:],X[48:53,:,:]),axis=0)
        y_train=np.concatenate((Y[0:42,:],Y[48:53,:]),axis=0)
        X_test=X[42:48,:,:]
        y_test=Y[42:48,:]
        
        Y_o=Y_Ori[42:48,:]
        Y_oo=np.concatenate((Y_Ori[0:42,:],Y_Ori[48:53,:]),axis=0)     
...
#create model
    ...
    m_name='DeepMIL_MeanPooling_Relu'+str(i)+'.h5'
...
sio.savemat('final_score_8fold_val_relu.mat',{'scores':final_score})